 ...
 * Image resizer class.
 *
 * Resizes an images to the given dimensions, quality and type.
 *
 * Based off the implementation in Winter CMS, originally developed by Alexey Bobkov and Samuel
 * Georges, and maintained by the Winter CMS maintainers.
 * (https://github.com/wintercms/storm/blob/develop/src/Database/Attach/Resizer.php).
 *
